...
function Collections() {
  ...
  return (
    <div className="w-[99vw] min-h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-start flex-col md:flex-row justify-start pt-[70px] overflow-x-hidden z-[2] pb-[110px]">
      ...
      <div
        className={`
          md:w-[30vw] lg:w-[20vw] w-[100vw] md:min-h-[100vh]
      ...
      >
        ...
        <div
          className={`
            border-[2px] border-[#dedcdc] pl-5 py-3 mt-6 rounded-md bg-slate-600
      ...
      <div className="lg:pl-[20%] md:py-[10px]">
        <div className="md:w-[80vw] w-[100vw] p-[20px] flex justify-between flex-col lg:flex-row lg:px-[50px]">
          ...
          <select
            className="bg-slate-600 w-[60%] md:w-[200px] h-[50px] px-[10px] text-white rounded-lg hover:border-[#46d1f7] border-[2px]" onChange={(e) => SetSortType(e.target.value)}
          >
        ...
        <div className=' lg:w-[80vw] w-[100vw] min-h-[70vh] flex items-center justify-center flex-wrap gap-[30px] ' >
          {
